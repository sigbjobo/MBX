...
#include "AtomId.h"
#include "NoSwitchFunction.cpp"
#include "CoarseGrainSwitch.cpp"
...
class OW_OW : public Polynomial {
  ...
  OW_OW() : Polynomial(OW_OW::get_system(), "OW_OW", 10, 1, OW_OW::get_nl_param_indices(), new CoarseGrainSwitch(2, 6.0, 8.0)) {}
...
class OW_OW_OW : public Polynomial {
    ...
    public:
        ...
        OW_OW_OW() : Polynomial(OW_OW_OW::get_system(), "OW_OW_OW", 10, 1, OW_OW_OW::get_nl_param_indices(), new CoarseGrainSwitch(3, 2.0, 4.0)) {}
...
class OW_OW_OW_OW : public Polynomial {
    ...
    public:
        ...
        OW_OW_OW_OW() : Polynomial(OW_OW_OW_OW::get_system(), "OW_OW_OW_OW", 10, 1, OW_OW_OW_OW::get_nl_param_indices(), new CoarseGrainSwitch(4, 2.0, 4.0)) {}
