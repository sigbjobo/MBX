...
/**
 * @brief Gets the four body energy for a given set of trimers
 *
 * Given the monomer ids of the trimer
 * and the number of monomers, will return the total sum
 * of the 4b energy of those tetramers. A trimer will be mon1-mon2-mon3-mon4.
 ...
 */
double get_4b_energy(std::string m1, std::string m2, std::string m3,   std::string m4, size_t nm, std::vector<double> xyz1,
 ...
 * Given the monomer ids of the trimer
 * and the number of monomers, will return the total sum
 * of the 4b energy of those trimers. A trimer will be mon1-mon2-mon3.
 * @param[in] m1 Monomer 1 id
 * @param[in] m2 Monomer 2 id
 * @param[in] m3 Monomer 3 id
 * @param[in] m4 Monomer 4 id
